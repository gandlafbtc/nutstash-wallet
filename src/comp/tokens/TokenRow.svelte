...
<tr>
	<td>
		<div class="flex gap-1 items-center">
			...
			<button on:click={()=>{tokenModal.show()}}>
	...
	<td>
		<div class=" flex gap-1 items-center overflow-x-clip">
				{#if lock}
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 {lock==='unlock'?'text-success':'text-error'}">
