...
>
	<div class="flex w-full justify-between">
			...
			<div>
				{#if level === 'success'}
					<svg
						...
						viewBox="0 0 24 24"
						fill="currentColor"
						class="w-6 h-6 text-success-content"
					>
						<path
							fill-rule="evenodd"
				...
				{:else if level === 'info'}
					<svg
						...
						viewBox="0 0 24 24"
						fill="currentColor"
						class="w-6 h-6 text-info-content"
					>
						<path
							fill-rule="evenodd"
				...
				{:else if level === 'warning'}
					<svg
						...
						viewBox="0 0 24 24"
						fill="currentColor"
						class="w-6 h-6 text-warning-content"
					>
						<path
							fill-rule="evenodd"
				...
				{:else if level === 'error'}
					<svg
						...
						viewBox="0 0 24 24"
						fill="currentColor"
						class="w-6 h-6 text-error-content"
					>
						<path
							fill-rule="evenodd"
		...
		<div class="flex flex-col gap-2 m-2 w-full h-full flex-grow">
