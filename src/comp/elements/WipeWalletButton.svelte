...
<div class="modal">
	<div class="modal-box">
		<p class="py-4 font-bold text-error">
			Warning!!!
		</p>
		<p class="py-4 ">
			You will delete all data from this browser-wallet, including tokens and mints. If you don't have a backup, you will lose access to your funds 
		</p>
