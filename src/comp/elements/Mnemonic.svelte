...
<div class="flex flex-col gap-6">
	...
	<div class="flex flex-col gap-1 items-center justify-center bg-base-200 p-2 rounded-xl">
		...
		<button on:click={copyMnemonic} class="btn btn-square btn-info btn-sm"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
