...
{#if !$useExternalNostrKey}
	...
	<dialog bind:this={newKeysModal} class="modal">
		<div class="modal-box">
			...
			<p class="py-4">
				Are you sure you want to delete your current and create new ones? Ecash locked to this key
				pair might become un-spendable. Make sure you have no locked ecash before proceeding
			</p>
