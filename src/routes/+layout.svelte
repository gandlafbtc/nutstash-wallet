<script lang="ts">
  ...
  import { page } from "$app/stores";
    import FileBackupButton from "$lib/elements/settings/backup/FileBackupButton.svelte";
    ...
    >
      <Drawer.Content>
        ...
        >
          ...
          <Drawer.Description
            >Enter an amount to receive via Lightning or paste a token to
            receive eCash.</Drawer.Description
          >
        </Drawer.Header>
        <Receive></Receive>
        <Drawer.Footer
