...
<div
	class="relative flex h-48 flex-col rounded-lg border bg-gradient-to-tr from-nutstash to-nutstashsecondary p-4 text-white shadow-md"
>
...
{#if mint.info.nuts[22]?.bat_max_mint}
<div class="mt-2">
	<Badge>Auth</Badge>
</div>
{/if}
