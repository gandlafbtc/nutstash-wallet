...
<Dialog.Root bind:open={isOpen}>
	<Dialog.Content>
		<Dialog.Header>
			<Dialog.Title class="text-destructive">Wallet already contains ecash!</Dialog.Title>
			<Dialog.Description>
				Adding the restored ecash will replace all ecash in the wallet. Only proceed if you are sure
		...
		<Dialog.Footer class="flex gap-2">
			...
			<Button variant="destructive" onclick={() => addToWallet(true)}>Add</Button>
		</Dialog.Footer>
	</Dialog.Content>
</Dialog.Root>
