            ...
            .then(() => {
                ...
                ndef.onreading = (event) => {
                    ...
                    if (scanned.startsWith("cashu")) {
                        ...
                        toast.warning(
                            "Scanned tag was not a cashu token: " + scanned,
                        );
                    }
                };
            })
...
<div class="flex items-center justify-center">
    <div class="relative bg-green-500 rounded-full w-1 h-1"></div>
    <div class="absolute bg-green-500 rounded-full w-2 h-2 animate-ping"></div>
</div>
