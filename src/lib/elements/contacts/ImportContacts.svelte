...
<div class="flex h-full w-80 flex-col gap-2 mt-32">
    ...
    <Button disabled={hasSelected} onclick={()=>{contactsStore.addMany($discoveredContacts)}}>
        Import all
    </Button>
    ...
    <ScrollArea class="h-96">
        ...
        <div class="my-2 flex gap-2 w-80 relative">
            ...
            {:else}
            <Button class="absolute right-2 m-1" onclick={()=>
             {
                hasSelected = true
